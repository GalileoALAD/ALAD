/*
  ...
  Copyright 2017 ALAD Foundation.
...
/// @title ALAD Protocol Token.
/// For more information about this token sale, please visit https://ALAD.org
/// @author Kongliang Zhong - <kongliang@ALAD.org>, Daniel Wang - <daniel@ALAD.org>.
contract ALADToken is StandardToken {
    string public constant NAME = "ALAD";
    string public constant SYMBOL = "ALAD";
     ...
     */
    function ALADToken(address _target) {
        target = _target;
    }
